                ...
                <div className="max-w-9xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
                    ...
                    <main className="lg:col-span-9 space-y-6 w-full">
                        ...
                        {searchQuery.trim() && !`
                            ...
                            Force Majeure General Legal Provisions KDP Select Pre-Orders Kindle Vella
                        ...
                        <div className="w-full flex flex-col md:items-start justify-between gap-6 pt-1">
                            ...
                            <div className="w-full space-y-5 text-sm text-gray-800 leading-relaxed">
                                ...
                                <ul className="list-disc pl-6 space-y-1 text-sm text-gray-800">
                                    ...
                                    <li>all rules and policies for participating in the Program provided on the KDP website (&quot;Program Policies&quot;);</li>
                                ...
                                <p>The Program will change over time and the terms of this Agreement will need to change over time as well. We reserve the right to change the terms of this Agreement. We will give you notice of the changes by one or more of the following methods: (1) posting new terms in place of the old with a revision date; (2) sending an email to your registered account address; (3) posting in the KDP Community Forum; (4) posting a banner in the KDP Portal; or (5) other reasonably substitutable means.</p>
                                ...
                                <p><strong>5.2.4 Optional Programs and Services.</strong> We may make available to you optional programs and services through KDP. Terms for those programs are included at the end of this Agreement.</p>

                                <p><strong>5.3 Pricing.</strong></p>
                                <p><strong>5.3.1 Providing Your List Price.</strong> The list price you provide to us is referred to as your &quot;List Price.&quot; You may change your List Price through the KDP website, and your change will be effective within 5 business days.</p>
                                ...
                                <p><strong>5.4.6 Payment Policies.</strong> We may require you to register a valid bank account in your KDP account in order to receive Royalty payments.</p>
                                ...
                                <h3 className="text-sm font-bold text-gray-900 pt-2">KDP Select Program</h3>
                                <p>KDP Select is an option for KDP publishers. While enrolled, your Digital Book must be exclusive to us and will be included in Kindle Unlimited. If there is any conflict among the terms in this Agreement, these KDP Select Terms and Conditions govern over the general KDP Terms and Conditions above.</p>
                                <p><strong>1. Exclusivity.</strong> When you include a Digital Book in KDP Select, you give us the exclusive right to sell and distribute your Digital Book in digital format. During this period, you cannot sell or distribute your Digital Book (or a substantially similar book) in digital format in any territory where you have rights.</p>
                                <p><strong>2. KDP Select Benefits.</strong></p>
                                <p><strong>2.1 Promotional Pricing Programs.</strong> During each 90-day KDP Select enrollment term, you may run your Digital Book in either a Kindle Countdown Deal or a free promotion (up to 5 days per 90-day period).</p>
                                <p><strong>2.2 Inclusion in Kindle Subscription Programs.</strong> Digital Books included in KDP Select will be automatically included in Kindle Subscription Programs.</p>
                                <p><strong>2.3 KDP Select Fund.</strong> We will establish a monthly fund and you will be eligible to earn a share based on the amount of your content read by customers in each marketplace.</p>
                                <p><strong>2.4 70% Royalty in Brazil, Japan, Mexico, and India.</strong> Digital Books enrolled in KDP Select will be eligible to earn 70% royalty for sales to customers in these territories.</p>
                                <p><strong>3. Period of Participation and Automatic Renewal.</strong> Once included, your Digital Book will be in KDP Select for a period of 90 days, automatically renewing unless you opt out through the KDP website before renewal.</p>
                                <p><strong>4. Book Eligibility.</strong> Because this option is for exclusive content, if you do not control the exclusive rights to your Digital Book, you cannot include it in KDP Select.</p>
                                ...
                                <h3 className="text-sm font-bold text-gray-900 pt-2">KDP Pre-Orders</h3>
                                ...
                                <p><strong>5. Inapplicable Terms.</strong> The following sections do not apply to Kindle Vella: 5.2.3 Lending Kindle Books, 5.3.1–5.3.3 List Price provisions, 5.4.1–5.4.4 Payment provisions, Terms and Conditions for KDP Select Program, and Terms and Conditions for KDP Pre-Orders.</p>
